...
from .attention import ProbAttention, FullAttention, AttentionLayer
...
class Informer(tf.keras.Model):
    ...
    def call(self, inputs, enc_self_mask=None, dec_self_mask=None, dec_enc_mask=None):
        if isinstance(inputs, (list, tuple)) and len(inputs) == 4:
                ...
                print(inputs)
                raise ValueError("Expected inputs to be a list or tuple of 4 tensors: x_enc, x_dec, x_mark_enc, x_mark_dec")
